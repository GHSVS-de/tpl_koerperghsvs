...
$this->getWebAssetManager()->registerAndUseStyle('template.system.error', 'system-site-error.css');
...
<body>
    <div class="error">
        ...
        <div id="errorboxoutline">
            ...
            <div id="errorboxbody">
            <p><strong><?php echo Text::_('Oooh, ein Fehler. Das tut mir leid!'); ?></strong></p>
						<p><strong><?php echo Text::_('Zurück zur Startseite:'); ?></strong> <a href="<?php echo Uri::root(true); ?>/index.php"><?php echo Text::_('JERROR_LAYOUT_HOME_PAGE'); ?></a></p>
						<p>&nbsp;</p>
